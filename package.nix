{
  ...
  # configuration
  linuxSystem,
  debugInsecurely ? true, # enable auto-login and passwordless sudo to root
  ...
  in
  {
    ...
    modules = [
      (
          ...
          systemd.services."${sshdKeys}" =
            ...
            in
            {
              ...
              script =
                ...
                in
                ''
                  # must be idempotent in the face of partial failures
        ...
        // (optionalAttrs (allowExtraConfig && (extraConfig != null)) extraConfig)
      )
    ];
